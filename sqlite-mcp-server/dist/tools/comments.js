...
export function getCommentTools() {
    return [
        {
            name: "list_comments",
...
export function registerCommentTools(registerHandler) {
    ...
    registerHandler("create_comment", async (args) => {
        ...
        await run("INSERT INTO comments (id, body, issue_id, user_id, parent_id, created_at, updated_at) VALUES (?, ?, ?, ?, ?, datetime('now'), datetime('now'))", [id, args.body, issueId, userId, args.parentId || null]);
